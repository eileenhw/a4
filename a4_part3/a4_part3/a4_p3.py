...
class Body(tk.Frame):
    ...
    def _draw(self):
        ...
        self.message_editor = tk.Text(message_frame,height = 5, width = 30) #added
        self.message_editor.pack(fill=tk.BOTH, expand = True, padx=5, pady=5) # added 
...
class Footer(tk.Frame):
    ...
    def _draw(self):
        self.delete_button = tk.Button(master=self, text="Delete", width=20,command = self.delete_click) #added command
        self.delete_button.pack(fill=tk.BOTH, side=tk.RIGHT, padx=5, pady=5)
        self.add_button = tk.Button(master=self, text="Add", width=20, command = self.add_click) #added command
...
class MainApp(tk.Frame):
    ...
    def _draw(self):
        ...
        menu_file.add_command(label='Open...', command = self.open_file) #added
        ...
        self.footer = Footer(self.root, self.add_clicked, self.delete_clicked) #added
